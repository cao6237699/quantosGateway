...
STRATEGY_ID_BINDING_COMPLETE = u'策略绑定完成'
STRATEGT_ID_BINDING_FAILED = u'策略绑定失败'

DATA_SERVER_CONNECTED = u'行情服务器连接成功'
DATA_SERVER_FAILED = u'行情服务器连接失败'
...
TRADING_SERVER_FAILED = u'交易服务器连接失败'
...
CONTRACT_DATA_FAILED = u'交易合约信息获取失败'